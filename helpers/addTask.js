...
const getTomorrowDetails = async(date) =>{
  try{
    ...
    return searchDate = currentDate.toLocaleDateString('en-us', options) ;
  }
  catch(err){
    const responsePayload = {
      status: 0,
...
const getTomorrowDetailsDefaultFormat = async(date)=>{
  try{
    let currentDate = new Date(date);
    let day2 = currentDate.getDate()
    //var month = currentDate.getMonth() + 1
    let year = currentDate.getFullYear()
    let month = String(currentDate.getMonth()+1).padStart(2,'0');
    return searchDate = `${year}-${month}-${day2}`;
  }catch(err){
    const responsePayload = {
      status: 0,
      message: null,
  ...
  try{
    ...
    if(type === 1){
      ...
      if(day === 5){
        ...
        searchDate = await getTomorrowDetails(new Date().getTime() + 48 * 60 * 60 * 1000)
        ...
        searchDate = await getTomorrowDetails(new Date().getTime() + 24 * 60 * 60 * 1000)
      ...
      let searchDate;
      if(day === 5){
          searchDate = await getTomorrowDetailsDefaultFormat(new Date().getTime() + 72 * 60 * 60 * 1000);
          // let currentDate = new Date(new Date().getTime() + 72 * 60 * 60 * 1000);
          // let day2 = currentDate.getDate()
          // //var month = currentDate.getMonth() + 1
          // let year = currentDate.getFullYear()
        ...
        searchDate = await getTomorrowDetailsDefaultFormat(new Date().getTime() + 48 * 60 * 60 * 1000);
        // let currentDate = new Date(new Date().getTime() + 48 * 60 * 60 * 1000);
        // let day2 = currentDate.getDate()
        // //var month = currentDate.getMonth() + 1
        // let year = currentDate.getFullYear()
        ...
        searchDate = await getTomorrowDetailsDefaultFormat(new Date().getTime() + 24 * 60 * 60 * 1000);
        // let currentDate = new Date(new Date().getTime() + 24 * 60 * 60 * 1000);
        // let day2 = currentDate.getDate()
        // //var month = currentDate.getMonth() + 1
        // let year = currentDate.getFullYear()
